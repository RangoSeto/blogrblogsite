                ...
                <div class="relative border border-blue-200 p-5 hover:bg-blue-50 group mb-3">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center">
                            <img src="{{empty($post->image) ? asset('assets/img/illu/noimage.jpg') : asset($post->image)}}" width="100" height="50" alt="post1" />
                            <div class="ps-5">
                        ...
                        <div class="flex flex-col items-end me-5">
                            <div class="flex items-center mb-2">
                                <span class="text-sm text-gray-500 me-3">{{$post->user->name}}</span>
                                <img src="{{empty($post->userdata()->image) ? asset('assets/img/illu/defaultimage.jpg') : asset($post->userdata()->image)}}" alt="user" class="w-10 h-10 rounded-full hover:cursor-pointer" />
                            </div>
